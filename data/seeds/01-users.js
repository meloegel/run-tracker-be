...
exports.seed = function (knex, Promise) {
  return knex('users').insert([
    { id: 1, username: 'Mark', password: 'asdasd', location: 'Detroit, MI', email: 'email@email.com', avatar: 'https://cdn0.iconfinder.com/data/icons/world-issues/500/running_man-512.png' },
