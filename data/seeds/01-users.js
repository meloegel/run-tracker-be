...
exports.seed = function (knex, Promise) {
  return knex('users').insert([
    ...
    { id: 2, username: 'RunnerDude', location: 'Denver, Co', password: 'asdasd', email: 'testemail@email.com', avatar: 'https://st4.depositphotos.com/3369547/25587/v/1600/depositphotos_255876378-stock-illustration-young-athletic-man-running-avatar.jpg' },
